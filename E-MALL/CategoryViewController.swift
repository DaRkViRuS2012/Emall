...
class subcategoryCell :UICollectionViewCell{
    ...
    let lineView:UIView={
        let v = UIView()
        v.backgroundColor = UIColor(white: 0.3, alpha: 0.9)
        return v
    ...
    func setupView(){
        ...
        addSubview(label)
        addSubview(lineView)
       _ = label.anchor(topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, topConstant: 0, leftConstant: 15, bottomConstant: 3, rightConstant: 15, widthConstant: 0, heightConstant: 0)
      _ = lineView.anchor(label.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, topConstant: 0, leftConstant: 15, bottomConstant: 0, rightConstant: 15, widthConstant: 0, heightConstant: 0.5)
